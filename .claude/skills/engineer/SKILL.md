...
5. Pause for the user. Silent unless something needs attention. Do not autonomously start the next step.
...
- **Reversible.** Each step ends in a state you could revert independently. No leaving the tree half-refactored across steps.
